...
public class Charisma implements EstrategiaAtaque {
    ...
    /**
     * Metodo void para imprimir uma frase aleatoria quando o Inimigo ataca
     */
    public void fraseInimigoRandom(){
        ...
        frasesAtaque.add(1, "O gaijo manda te um peidito e abana a mão para o cheiro ir na tua direção");
    ...
    /**
     * Funcao para generar uma frase aleatoria para um ataque do Heroi
     */
    ...
    /**
     * Metodo para o ataque Charisma do heroi com override da classe pai da Interface Estrategia de ataque!
     * @return Entidade
     */
    @Override
            ...
            switch (opcao) {
                ...
                case 1:
                    ...
                    if (npc.getHP()>(heroi.getPower()+heroi.getArmaPrincipal().getAtaque())) {
                        ...
                        System.out.println("");
                        System.out.println("Deste o mico ao gaijo e ganhaste: "+ouroDropado+" paus");
