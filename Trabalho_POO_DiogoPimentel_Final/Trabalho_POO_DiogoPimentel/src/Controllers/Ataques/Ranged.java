...
public class Ranged implements EstrategiaAtaque {
    ...
    /**
     * Metodo para o ataque Ranged do heroi com override da classe pai da Interface Estrategia de ataque
     * @return Entidade
     */
    @Override
    public Entidade ataquePai(NPC npc, Heroi heroi) {
        ...
        int ataqueNPC = (int) (npc.getPower()*1.1);
        int opcao;
        int ouroDropado;
